...
public class AES {
    ...
    private static final int ROUND_KEY_SIZE = 128;
    private static final int EXP_KEY_SIZE = 1408;
    private static final int GF_SIZE = 8;
    private static final int WORD_SIZE = 4;
    private static final int BYTE_SIZE = 8;
    private static final int POLY_MX = 0x1B;
    private static final int GF_DIMENSION = 1 << GF_SIZE;
    private static final int ENCRYPT = 0;
    private static final int DECRYPT = 1;
    private int[][] multiplicationTable, roundKey;
